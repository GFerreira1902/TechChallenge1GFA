...
**Interpretação:** A maioria das features mais influentes empurra a decisão para maligno quando se tem valores de coeficientes altos. A exceção é o "compactness_se", que quando alto puxa para benigno.
